...
log "Начало создания инфраструктуры для ${PROJECT_NAME}"
...
log "Создание Yandex Database..."
yc ydb database create ${YDB_NAME} \
    --serverless \
    --folder-id ${FOLDER_ID}

log "Получение информации о YDB..."
...
log "Создание статического ключа для Docker..."
...
log "Инфраструктура создана успешно!"
